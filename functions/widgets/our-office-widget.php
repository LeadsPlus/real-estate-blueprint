<?php class OurOfficeWidget extends WP_Widget {
	
	function OurOfficeWidget() {
		// Instantiate the parent object
		// parent::__construct( false, 'Our Office Widget' );
		$widget_ops = array( 'classname' => 'example', 'description' => 'Change the title of the "Our Office" widget.' );
				...
				/* Create the widget. */
				$this->WP_Widget( 'OurOfficeWidget', 'Our Office Widget', $widget_ops, $control_ops );
	...
	function form( $instance ) {
		...
		$instance = wp_parse_args( (array) $instance, array( 'title' => 'Our Office', 'subtitle' => 'Stop by our office, we would love to see you!', 'street_address' => '65 Bellevue Avenue', 'city_state_zip' => 'Newport, RI, 02840', 'lat' => '41.486097', 'lng' => '-71.308929' ) );
