...
$('body.page-template-page-template-listings-php .dataTables_paginate span a, body.page-template-page-template-listings-php .dataTables_paginate a.paginate_button').live('click', function (){
